...
Write-Host "Checking the pods in the $NAMESPACE_SINGLE namespace..."
try {
  kubectl get pods -n $NAMESPACE_SINGLE
}
catch {
  Write-Host "Failed to retrieve pods in the $NAMESPACE_SINGLE namespace. Please check your Kubernetes cluster."
  exit 1
}

Write-Host "Next steps:"
Write-Host "1. Monitor the runner pods in the $NAMESPACE_SINGLE namespace using:"
Write-Host "   kubectl get pods -n $NAMESPACE_SINGLE"
